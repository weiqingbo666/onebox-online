  ...
  return (
    <div className="h-screen flex items-center">
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col p-4 bg-[#fbfeed] rounded-2xl shadow-sm border-2 border-[#b5e48c] h-[calc(100vh-16rem)]">
          ...
          <div className="h-[45%] w-full p-4 bg-white rounded-lg shadow-sm mb-4">
          ...
          <div className="h-[25%] p-4 flex items-center">
            <button
